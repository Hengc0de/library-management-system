<?php
    ...
    $user_is_admin = mysqli_fetch_array($user_check_result);
    $user_is_admin_or_no = $user_is_admin['is_admin'];
    if (!$user_is_admin_or_no == 1){
    ...
    <div class="container">
        <div class="navigation">
            <ul>
                ...
                <li>
                    <a href="approve-book.php">
                        <span class="icon">
                        <i class="fa-solid fa-circle-check"></i>
                        </span>
                        <span class="title">Approve Books</span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="add-genre.php">
                        <span class="icon">
                        <i class="fa-solid fa-folder-plus"></i>
                        </span>
                        <span class="title">Add New Genre</span>
                    </a>
                </li>
