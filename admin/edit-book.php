                ...
                <form action="edit-book-logic.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="input-box">
                            ...
                            <input type="text" value="<?= $book['available'] ?>" required placeholder="Add Stock Quantity" name="available">
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-box">
                            <span class="title">Is_Latest <small style="color: grey;">1 for "yes" 0 for "no"</small></span>
                            <input type="text" value="<?= $book['is_latest'] ?>" required placeholder="Add Stock Quantity" name="is_latest">
                        </div>
                        <div class="input-box">
                            <span class="title">Is_Trending <small style="color: grey;">1 for "yes" 0 for "no"</small></span>
                            <input type="text" value="<?= $book['is_trending'] ?>" required placeholder="Add Stock Quantity" name="is_trending">
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-box">
                            <span class="title">Is_Featured <small style="color: grey;">1 for "yes" 0 for "no"</small></span>
                            <input type="text" value="<?= $book['is_featured'] ?>" required placeholder="Add Stock Quantity" name="is_featured">
                        </div>
                        <div class="input-box">
                            <span class="title">Featured Background</span>
                            <input type="file" placeholder="Add Stock Quantity" name="featured_background">
                        </div>
                    </div>
