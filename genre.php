...
<?php include 'partials/main.php' ?>
        ...
        <div class="right-side">
            ...
            <div class="title">
                <?php
                    $zin_id = $_GET['id'];
                    $zin_query = "SELECT * FROM genres where id = $zin_id";
                    $zin_result = mysqli_query($connection, $zin_query);
                    $zin = mysqli_fetch_assoc($zin_result);
                ?>
                <h1><?= $zin['name'] ?></h1>
            </div>
                <div class="book-shelf">
                    <?php
                        $book_query = "SELECT * from books where genre_id = $zin_id";
