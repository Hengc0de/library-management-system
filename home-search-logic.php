        ...
        <div class="right-side">
            ...
            <div class="title">
                ...
                <div class="book-shelf">
                    <?php
                        $book_query = "SELECT * FROM books where title LIKE '%$search%' or author LIKE '%$search%' or year LIKE '%$search%' or genre_id LIKE '%$search%' or description LIKE '%$search%'";
                    ...
                    <?php else : ?>
                        ...
                        <p style="color: var(--color-black-light); font-size: 40px; text-align:center">No book match your search</p>
